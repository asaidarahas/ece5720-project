...
namespace mnist
{
    ...
    {
        std::string full_path = path + "/train-images-idx3-ubyte-fashion";
    ...
    {
        return read_mnist_images(path + "/train-images-idx3-ubyte-fashion", limit);
    }

    std::vector<uint8_t> read_test_images(const std::string &path, std::size_t limit)
    {
        return read_mnist_images(path + "/t10k-images-idx3-ubyte-fashion", limit);
    }

    std::vector<int> read_training_labels(const std::string &path, std::size_t limit)
    {
        return read_mnist_labels(path + "/train-labels-idx1-ubyte-fashion", limit);
    }

    std::vector<int> read_test_labels(const std::string &path, std::size_t limit)
    {
        return read_mnist_labels(path + "/t10k-labels-idx1-ubyte-fashion", limit);
    } 
